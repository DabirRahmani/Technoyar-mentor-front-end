...
import EnterLogOutRequest from "../backend/enterLogOutRequest";
    ...
    if (
      ...
      return (
        <View style={{ justifyContent: "center", alignItems: "center" }}>
          <MainTexts.MainContextSubTexts title="وارد نشده" />
        </View>
      );
    if (
      report.exitTime !== "" &&
      report.exitTime !== undefined &&
      report.exitTime !== null
    )
      return (
        <View style={{ justifyContent: "center", alignItems: "center" }}>
          <MainTexts.MainContextSubTexts title={report.exitTime} />
        </View>
      );

    return (
      <MeduimMainButton title="ثبت خروج" onPress={() => setModalStatus(true)} />
    );
  };
    ...
    <MainScreen>
      <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
        ...
        <View style={{ marginRight: 32 }}>
          <MainTexts.MainTitleTexts title="ثبت خروج کاربران" />
        </View>
      </View>
...
export default EnterLogoutScreen;
